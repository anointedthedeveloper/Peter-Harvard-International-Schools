...
const Dashboard = () => {
    ...
    <aside className={`flex flex-col w-60 shrink-0 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 fixed top-14 bottom-0 left-0 overflow-y-auto z-20 transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
      ...
      <div className="px-5 py-5 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-black text-gray-900 dark:text-white text-sm leading-tight">Peter Harvard Int'l Schools</p>
            <p className="text-[11px] text-green-600 dark:text-green-500 font-semibold">Admin Panel</p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
      ...
      {/* Top bar â€” full width, sits right below the site navbar */}
      ...
      {/* Body row */}
      <div className="flex flex-1 min-h-0 mt-14">
